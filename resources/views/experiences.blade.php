...
<html lang="en">
  <head>
    <title>Experiences - Ricky Yap</title>
    <meta charset="utf-8">
  ...
  <body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
    ...
    <section> {{-- banner --}}
      <div class="mx-auto w-100" style="margin: 150px 0 0 0; ">
        <h1 style="font-weight: bold; text-align: center;">
        <span
           class="txt-rotate"
           data-period="2000"
           data-rotate='[ "Experiences" ]'></span>
      </h1>
      </div>
    </section>
    			...
    			<div class="col-md-3">
				    <nav id="navi">
					    <ul>
					      ...
					      <li><a href="#page-2">Jobs</a></li>
					      <li><a href="#page-3">Events</a></li>
					    </ul>
					  </nav>
					</div>
					<div class="col-md-9">
					  <div id="page-1" class= "page one">
					    ...
					    <div class="resume-wrap d-flex ftco-animate">
					    	...
					    	<div class="text pl-3">
		    					...
		    					<span class="position">Universitas Pelita Harapan</span>
		    					<p>CGPA: 3,92</p>
	    					</div>
	    				</div>
	    				<div class="resume-wrap d-flex ftco-animate">
					    	...
					    	<div class="text pl-3">
		    					...
		    					<h2>Senior High School - Science Major</h2>
		    					<span class="position">SMA Prime One School</span>
		    				</div>
	    				</div>
					  </div>
					  ...
					  <div id="page-2" class= "page two">
					    ...
					    <div class="resume-wrap d-flex ftco-animate">
					    	...
					    	<div class="text pl-3">
		    					...
		    					<h2>UI/UX Intern</h2>
		    					<span class="position">PT Nirvana Indonesia Yoga and PT Kelas Fitness Indonesia</span>
		    					<p>Designing mobile and web user interfaces, and UX Research to further improve CX.</p>
		    				</div>
	    				</div>
	    				<div class="resume-wrap d-flex ftco-animate">
	    					<div class="icon d-flex align-items-center justify-content-center">
					    	...
					    	<div class="text pl-3">
		    					...
		    					<h2>Head of Medkominfo</h2>
		    					<span class="position">Himpunan Mahasiswa Program Studi Sistem Informasi - UPH Medan Campus</span>
		    				</div>
	    				</div>
                        <div class="resume-wrap d-flex ftco-animate">
	    					<div class="icon d-flex align-items-center justify-content-center">
					    	...
					    	<div class="text pl-3">
		    					...
		    					<h2>Advisor</h2>
		    					<span class="position">POGA Club - UPH Medan Campus</span>
		    				</div>
	    				</div>
                        <div class="resume-wrap d-flex ftco-animate">
	    					<div class="icon d-flex align-items-center justify-content-center">
                      ...
                      <div class="resume-wrap d-flex ftco-animate">
                          ...
                          <div class="text pl-3">
                              ...
                              <h2>Head of Publikasi, Desain, dan Dokumentasi</h2>
                              <span class="position">Leadership Development Camp 2022</span>
                          </div>
                      </div>
                      <div class="resume-wrap d-flex ftco-animate">
                          <div class="icon d-flex align-items-center justify-content-center">
                          ...
                          <div class="text pl-3">
                              ...
                              <span class="position">Designeroad 2022</span>
                          </div>
                      </div>
                      <div class="resume-wrap d-flex ftco-animate">
                          <div class="icon d-flex align-items-center justify-content-center">
                          ...
                          <div class="text pl-3">
                              <span class="date">2022</span>
                              <h2>Tutor of Basic Design Class</h2>
                              <span class="position">Designeroad 2022</span>
                          </div>
                      </div>
                      <div class="resume-wrap d-flex ftco-animate">
                          ...
                          <div class="text pl-3">
                              <span class="date">2022</span>
                              <h2>Member of Design Division</h2>
                              <span class="position">Ambassadors of UPH Medan Campus 2022</span>
                          </div>
                      </div>
                      <div class="resume-wrap d-flex ftco-animate">
                        <div class="icon d-flex align-items-center justify-content-center">
                        ...
                        <div class="text pl-3">
                            <span class="date">2022</span>
                            <h2>Member of Design Division</h2>
                            <span class="position">Komisi Pemilihan Umum UPH Medan Campus 2022</span>
                        </div>
                    </div>
