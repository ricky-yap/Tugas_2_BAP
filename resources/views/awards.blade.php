...
<html lang="en">
  ...
  <body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
    ...
    <div class="container-fluid px-md-5" style="margin: 8em 0;">
      ...
      <div class="col-md-12 heading-section text-center ftco-animate">
        <h1 style="font-weight: bold; text-align: center;">
            <span
                class="txt-rotate"
                data-period="2000"
                data-rotate='[ "Awards" ]'></span>
            </h1>
        <p>Collection of awards across the years</p>
      </div>
    </div>
    </section>
    ...
    <section class="ftco-section" id="services-section">
    		<div class="row">
					<div class="col-md-8 text-center d-flex ftco-animate">
						<a href="#" class="services-1 shadow">
							<span class="icon">
								<img src="images/PMI.png" style="width: 20%;">
							</span>
							<div class="desc">
								<h3 class="mb-5">PMI Project Management Ready&#8482;</h3>
								<p>Issued by the Project Management Institute on 2022</p>
							</div>
						</a>
                    </div>
					<div class="col-md-4 text-center d-flex ftco-animate">
						<a href="#" class="services-1 shadow">
							<span class="icon">
                                <img src="images/SISTECH.png" style="width: 15%; margin: 5% 0;">
							</span>
							<div class="desc">
								<h3 class="mb-5">Basic Design Class</h3>
								<p>Issued by SISTECH UPH Kampus Medan on 2021</p>
							</div>
						</a>
					</div>
					<div class="col-md-4 text-center d-flex ftco-animate">
						<a href="#" class="services-1 shadow">
							<span class="icon">
								<img src="images/UPH.png" style="width: 15%;">
							</span>
							<div class="desc">
								<h3 class="mb-5">BRONZE UPH SCHOLARSHIP AWARDEE</h3>
								<p>for the 2022 - 2023 Academic Year </p>
							</div>
						</a>
					</div>
                    ...
                    <div class="col-md-4 text-center d-flex ftco-animate">
						<a href="#" class="services-1 shadow">
							...
							<div class="desc">
								<h3 class="mb-5">BRONZE UPH SCHOLARSHIP AWARDEE</h3>
								<p>for the 2021 - 2022 Academic Year </p>
							</div>
						</a>
					</div>
                    ...
                    <div class="col-md-4 text-center d-flex ftco-animate">
						<a href="#" class="services-1 shadow">
							...
							<div class="desc">
								<h3 class="mb-5">SILVER UPH SCHOLARSHIP AWARDEE</h3>
								<p>for the 2020 - 2021 Academic Year </p>
							</div>
						</a>
					</div>
				</div>
