...
<nav id="top-menu" class="navbar navbar-default navbar-fixed-top">
  <div class="container"> 
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="home"><img src="img/logo-top.png" style="width: auto; height: 44px;" class="img-responsive"></a></div>
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1"> 
      ...
      <ul id="nav-top" class="nav navbar-nav navbar-right">
        ...
        <li><a href="jeje" class="page-scroll">Blog</a></li>
  ...
  <div class="container">
    <div class="row"> 
      ...
      <div class="section-title text-center wow fadeInUp">
        ...
        <p>I am an undergraduate student majoring in Information Systems in UPH Medan Campus. I am passionate in the world of design, currently working in various campus organizations, with detail-oriented projects and well-organized workflows.</p>
      </div>
      <!--/section-title-->
      ...
      <ul class="about-features wow fadeInUp">
        <li>
          <i><img src="img/fcpx.jpeg" style="width: 70px; height: auto;"></i>
