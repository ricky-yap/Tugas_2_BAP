...
<html lang="en">
  ...
  <body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
		  				...
		  				<h1>Ricky Yap</h1>
			  				<h2>I'm a 
								  <span
								     class="txt-rotate"
								     data-period="2000"
								     data-rotate='[ "UI/UX Designer.", "Videographer.", "Web Developer."  ]'></span>
								</h2>
							</div>
            </div>
          </div>
	...
	<hr style="border: 0; height: 100px; border-top: 50px solid white;" id="about-section">
    		...
    		<div class="row d-flex no-gutters">
    			...
    			<div class="col-md-6 col-lg-6 pl-md-5 py-5">
		          ...
		          <div class="col-md-12 heading-section ftco-animate">
		            ...
		            <p>I am an undergraduate student majoring in Information Systems in UPH Medan Campus. I am passionate in the world of design, currently working in various companies, with detail-oriented projects and well-organized workflows.</p>
              ...
              <div class="text">
                ...
                <p><a href="https://www.linkedin.com/in/ricky-yap/" class="btn btn-primary py-32 px-3">See Curriculum Vitae</a></p>
              </div>
	          </div>
	        </div>
        </div>
